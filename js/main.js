...
$(function() {
  var bookmark = {
    data: [{
      ...
      name: 'Yeah',
      link: 'https://smart.mail.yeah.net/',
      box_shadow: '#D7191A',
      icon: 'img/yeah.png',
    }, {
      name: '阿里云',
      ...
      name: 'Github',
      link: 'https://github.com/kiwibrowser/src.next/releases/',
      box_shadow: '#62677b',
      icon: 'img/githublog.png',
    }, {
      name: 'Q邮',
...
$(function() {
  var search = {
    data: [{
      ...
      searchlink: 'https://searchcode.com/?q=',
      searchname: 'q',
      color: '#575757',
      placeholder: '搜索代码...'
    }, {
      ...
      searchlink: 'https://startpage.com/do/search?cat=web&query=',
      searchname: 'q',
      color: '#414baa',
